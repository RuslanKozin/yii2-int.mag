<div class="table-responsive">
    <table style="width: 100%; border: 1px solid #ddd; border-collapse: collapse;">
        ...
        <?php foreach($session['cart'] as $id => $item):?>
            <tr>
                <td style="padding: 8px; border: 1px solid #ddd;"><?= $item['name']?></td><?= // \yii\helpers\Url::to(['product/view', 'id' => $id], true) ссылка будет формироваться с нашим доменом (абсолютная) ?>
